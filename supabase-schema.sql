...
CREATE TABLE products (
  ...
  category TEXT NOT NULL CHECK (category IN ('tshirt', 'hoodie', 'accessories')),
  image TEXT,
  description TEXT,
...
('Eye Tee Black', 35.00, 'tshirt', '/images/products/tee-black.jpg', 'T-shirt nera con logo Eyegonal frontale'),
('Eye Tee White', 35.00, 'tshirt', '/images/products/tee-white.jpg', 'T-shirt bianca con logo Eyegonal frontale'),
('Hexagon Hoodie Black', 55.00, 'hoodie', '/images/products/hoodie-black.jpg', 'Felpa nera con cappuccio e logo esagonale'),
('Hexagon Hoodie White', 55.00, 'hoodie', '/images/products/hoodie-white.jpg', 'Felpa bianca con cappuccio e logo esagonale'),
('Eye Long Sleeve Black', 42.00, 'tshirt', '/images/products/longsleeve-black.jpg', 'Maglia a maniche lunghe nera'),
('Eye Long Sleeve White', 42.00, 'tshirt', '/images/products/longsleeve-white.jpg', 'Maglia a maniche lunghe bianca');
